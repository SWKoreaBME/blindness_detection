...
from aug_dataset import aptos_dataset, dataloaders
...
da_dir = '/media/sangwook/MGTEC/blindness_detection_data/aug_images/'

dataset = aptos_dataset(d_path=data_dir, da_root_path=da_dir, label_file=label_file)
...
torch.save(model_best.state_dict(), './checkpoint/rule_based_augmented_classifier_model.pth')